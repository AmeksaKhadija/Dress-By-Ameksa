...
import useVendeurProfile from '../../hooks/useVendeurProfile';

const VendeurProfile = () => {
  const { profile, loading, saving, handleUpdate, handleChangePassword } = useVendeurProfile();
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
          <div className="flex items-center gap-3 mb-5">
            <div className="p-2 bg-primary-50 rounded-lg">
              <HiUser className="text-primary-600" size={22} />
            </div>
