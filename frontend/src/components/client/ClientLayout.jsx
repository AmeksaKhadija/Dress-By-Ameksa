    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="lg:hidden flex items-center justify-between px-4 py-3 bg-white border-b shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <span className="font-semibold text-gray-900">Mon Espace</span>
        </div>
        <div className="flex items-center gap-3">
          <Link to="/client/notifications" className="relative text-gray-500 hover:text-primary-600 transition">
            <HiBell size={22} />
            {unreadCount > 0 && (
