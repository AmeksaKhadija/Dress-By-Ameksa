...
const links = [
  ...
  { to: '/admin/boutiques', label: 'Boutiques', icon: HiShoppingBag },
  { to: '/admin/reservations', label: 'Reservations', icon: HiClipboardList },
  { to: '/admin/commissions', label: 'Commissions', icon: HiCurrencyDollar },
];
      ...
      <div className="flex">
        ...
        >
          <div className="p-5 flex flex-col h-full">
            {/* User card */}
            <div className="hidden lg:flex items-center gap-3 p-4 mb-6 bg-gradient-to-r from-indigo-50 to-indigo-100/50 rounded-xl">
              <div className="w-11 h-11 rounded-full bg-indigo-600 text-white flex items-center justify-center text-sm font-bold flex-shrink-0">
                {initials}
              </div>
